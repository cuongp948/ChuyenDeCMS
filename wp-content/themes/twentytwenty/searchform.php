                ...
                <div class="col-12 col-md-10 col-lg-8">
                    <form class="card card-sm">
                        <div class="card-body row no-gutters align-items-center">
                            ...
                            <!--end of col-->
                            <div class="col">
                                <input class="form-control form-control-lg form-control-borderless" type="search" placeholder="<?php echo esc_attr_x( 'Scearch &hellip;', 'placeholder', 'twentytwenty' ); ?>" value="<?php echo get_search_query(); ?>" name="s">
                            </div>
                            <!--end of col-->
                            <div class="col-auto" value="<?php echo esc_attr_x( 'Search', 'submit button', 'twentytwenty' ); ?>">
